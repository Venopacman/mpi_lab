...
def integrateRange(a, b, n):
    ...
    for i in range(1,int(n)):
        x = a + i*h
        integral = integral + f(x -0.5*h)*h
    return integral


# h is the step size. n is the total number of rectangulars
h = (b - a) / n
# local_n is the number of rectangulars each process will calculate
